...
public class FetchRequestData implements ApiMessage {
    ...
    public static final Schema SCHEMA_13 =
        new Schema(
            ...
            new Field("session_id", Type.INT32, "The fetch session ID."),
            new Field("session_epoch", Type.INT32, "The fetch session epoch, which is used for ordering requests in a session."),
            new Field("topics", new CompactArrayOf(FetchTopic.SCHEMA_13), "The topics to fetch."),
            new Field("forgotten_topics_data", new CompactArrayOf(ForgottenTopic.SCHEMA_13), "In an incremental fetch request, the partitions to remove."),
            new Field("rack_id", Type.COMPACT_STRING, "Rack ID of the consumer making this request"),
            TaggedFieldsSection.of(
                0, new Field("cluster_id", Type.COMPACT_NULLABLE_STRING, "The clusterId if known. This is used to validate metadata fetches prior to broker registration.")
            )
    ...
    public static final Schema SCHEMA_15 =
        new Schema(
            new Field("max_wait_ms", Type.INT32, "The maximum time in milliseconds to wait for the response."),
            new Field("min_bytes", Type.INT32, "The minimum bytes to accumulate in the response."),
            new Field("max_bytes", Type.INT32, "The maximum bytes to fetch.  See KIP-74 for cases where this limit may not be honored."),
            ...
            TaggedFieldsSection.of(
                0, new Field("cluster_id", Type.COMPACT_NULLABLE_STRING, "The clusterId if known. This is used to validate metadata fetches prior to broker registration."),
                1, new Field("replica_state", ReplicaState.SCHEMA_15, "")
            )
        );
    ...
    public static final short HIGHEST_SUPPORTED_VERSION = 15;
        ...
        if (_version >= 12) {
            ...
            for (int _i = 0; _i < _numTaggedFields; _i++) {
                ...
                switch (_tag) {
                    ...
                    case 1: {
                        if (_version >= 15) {
                            this.replicaState = new ReplicaState(_readable, _version);
                            break;
                        } else {
    ...
    public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
        ...
        if (_version <= 14) {
            ...
            if (this.replicaId != -1) {
                throw new UnsupportedVersionException("Attempted to write a non-default replicaId at version " + _version);
            }
        }
        if (_version >= 15) {
            ...
            if (!this.replicaState.equals(new ReplicaState())) {
                throw new UnsupportedVersionException("Attempted to write a non-default replicaState at version " + _version);
            }
        }
        ...
        if (_version >= 15) {
            {
                if (!this.replicaState.equals(new ReplicaState())) {
                    ...
                    this.replicaState.addSize(_size, _cache, _version);
    ...
    public FetchRequestData duplicate() {
        ...
        _duplicate.replicaState = replicaState.duplicate();
    ...
    public FetchRequestData setReplicaState(ReplicaState v) {
        this.replicaState = v;
        return this;
    }
    ...
    public static class ReplicaState implements Message {
        ...
        public static final Schema SCHEMA_15 =
            new Schema(
                new Field("replica_id", Type.INT32, "The replica ID of the follower, or -1 if this request is from a consumer."),
                new Field("replica_epoch", Type.INT64, "The epoch of this follower, or -1 if not available."),
                TaggedFieldsSection.of(
                )
            );
        ...
        public static final short LOWEST_SUPPORTED_VERSION = 15;
        public static final short HIGHEST_SUPPORTED_VERSION = 15;
        ...
        public void read(Readable _readable, short _version) {
            if (_version > 15) {
                throw new UnsupportedVersionException("Can't read version " + _version + " of ReplicaState");
            }
            this.replicaId = _readable.readInt();
            this.replicaEpoch = _readable.readLong();
            this._unknownTaggedFields = null;
            int _numTaggedFields = _readable.readUnsignedVarint();
            for (int _i = 0; _i < _numTaggedFields; _i++) {
                int _tag = _readable.readUnsignedVarint();
        ...
        public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
            if (_version < 15) {
                throw new UnsupportedVersionException("Can't write version " + _version + " of ReplicaState");
            }
            int _numTaggedFields = 0;
            _writable.writeInt(replicaId);
            _writable.writeLong(replicaEpoch);
            RawTaggedFieldWriter _rawWriter = RawTaggedFieldWriter.forFields(_unknownTaggedFields);
            _numTaggedFields += _rawWriter.numFields();
            _writable.writeUnsignedVarint(_numTaggedFields);
            _rawWriter.writeRawTags(_writable, Integer.MAX_VALUE);
        ...
        public void addSize(MessageSizeAccumulator _size, ObjectSerializationCache _cache, short _version) {
            int _numTaggedFields = 0;
            if (_version > 15) {
                throw new UnsupportedVersionException("Can't size version " + _version + " of ReplicaState");
            }
            _size.addBytes(4);
            _size.addBytes(8);
            if (_unknownTaggedFields != null) {
        ...
        public int hashCode() {
            int hashCode = 0;
            hashCode = 31 * hashCode + replicaId;
            hashCode = 31 * hashCode + ((int) (replicaEpoch >> 32) ^ (int) replicaEpoch);
            return hashCode;
        }
        ...
        public ReplicaState setReplicaEpoch(long v) {
            this.replicaEpoch = v;
            return this;
        }
    }
