...
public class CreateAclsResponseData implements ApiMessage {
    int throttleTimeMs;
    List<AclCreationResult> results;
    ...
    public CreateAclsResponseData() {
        ...
        this.results = new ArrayList<AclCreationResult>(0);
    }
        ...
        this.throttleTimeMs = _readable.readInt();
        {
            if (_version >= 2) {
                ...
                if (arrayLength < 0) {
                    ...
                    ArrayList<AclCreationResult> newCollection = new ArrayList<>(arrayLength);
    ...
    public CreateAclsResponseData duplicate() {
        CreateAclsResponseData _duplicate = new CreateAclsResponseData();
        _duplicate.throttleTimeMs = throttleTimeMs;
        ArrayList<AclCreationResult> newResults = new ArrayList<AclCreationResult>(results.size());
        for (AclCreationResult _element : results) {
    ...
    public static class AclCreationResult implements Message {
        ...
        public AclCreationResult duplicate() {
            AclCreationResult _duplicate = new AclCreationResult();
